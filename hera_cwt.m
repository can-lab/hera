function [coefs,varargout] = cwt(SIG,scales,WAV,handles,plotmode,xlim) %handles added (EJH) for progress bar access
...
% Test for plots.
%----------------
if nargin<5 , return; end %was 4 (handles added; EJH)
